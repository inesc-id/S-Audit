...
public class LocalDiskDriver
    ...
    public LocalDiskDriver(String driverpath, String ip) {
        this(driverpath, ip, 5555);
    }

    public LocalDiskDriver(String driverpath, String ip, int port) {
        ...
        try {
            ...
            try {
                ...
                if (msg.getOp().equals("ok")) {
                    ...
                    throw new StorageCloudException(
                            "Container creation failed... maybe container already exist.");
                }
            } catch (ClassNotFoundException e) {
                e.printStackTrace();
            }
