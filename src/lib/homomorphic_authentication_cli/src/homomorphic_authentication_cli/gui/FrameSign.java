...
public class FrameSign {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    FrameSign window = new FrameSign();
    ...
    public void buttonSubmit() {
        ...
        try {
            s = new StorageTagger(FileSystemHandler.readFile(pairingPath),
                    ...
                    FileSystemHandler.readFileBytes(fILE_PATH), false);
            textArea.setText(s.run());
            FileSystemHandler.writeFile(s.getSignatureFileName(), s.getSignatureContent());
            textArea.append("\n>" + "SUCCESS");
        } catch (IOException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
