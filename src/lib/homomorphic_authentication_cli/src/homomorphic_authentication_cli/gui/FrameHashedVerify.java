...
public class FrameHashedVerify {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    FrameHashedVerify window = new FrameHashedVerify();
    ...
    private void initialize() {
        ...
        verticalBox.setBounds(0, 26, 432, 236);
        ...
        textArea.setBounds(0, 238, 434, 160);
    ...
    public void buttonSubmit() {
        ...
        try {
            s = new HashedTagVerifier(FileSystemHandler.readFile(pairingPath),
                    ...
                    FileSystemHandler.readFileBytes(fILE_PATH), gran, fILE_ID + ".sig",
                    FileSystemHandler.readFileBytes(sIGNATURE_OUT_FILE_PATH));
