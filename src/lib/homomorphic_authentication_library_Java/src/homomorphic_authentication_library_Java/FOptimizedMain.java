...
import homomorphic_authentication_library_Java.crypto.integrity_proofs.proof_verifier.optimized.ProofVerifier;
...
public class FOptimizedMain {
    public static void main(String[] args) {
        ...
        // Setup
        ///////////////
        String param_a = "type a\n"
                + "q 9577926024399216029703282733934324404811776682691869609509229707971766256867240123865753940650139002129670246439360669559625062833478342758748376053243719\n"
                + "r 730750818665451621361119245571504901405976559617\n"
                + "h 13106965849030584806462797797049171886209415580909486764042543312467282533068516108205802406523710455865160\n"
                + "exp1 107\n" + "exp2 159\n" + "sign0 1\n" + "sign1 1\n";
        PairingGenerator p = ParingGeneratorFactory.getGenerator(param_a);
        System.out.println(p.getClass());
        PairingGenerator pG = new PairingFGenerator(160);
        pG.generate();
        ...
        BLSOptimized bls0 = new BLSOptimized(pairingParameters, g, w0);
        ...
        System.out.println("Sig Size: " + sig0_1[0].length);
        ...
        BLSOptimized bls1 = new BLSOptimized(pairingParameters, g, w1);
        ...
        */
        ...
        System.out.println("Size G1: " + pairing.getG1().getLengthInBytes());
        System.out.println("Size G2: " + pairing.getG2().getLengthInBytes());
        System.out.println("Size GT: " + pairing.getGT().getLengthInBytes());
        System.out.println("Size Zr: " + pairing.getZr().getLengthInBytes());
        System.out.println(
                "Size Canonical G1: " + pairing.getG1().getCanonicalRepresentationLengthInBytes());
        System.out.println(
                "Size Canonical G2: " + pairing.getG2().getCanonicalRepresentationLengthInBytes());
        System.out.println(
                "Size Canonical GT: " + pairing.getGT().getCanonicalRepresentationLengthInBytes());
        System.out.println(
                "Size Canonical Zr: " + pairing.getZr().getCanonicalRepresentationLengthInBytes());
        System.out.println("Size Compressed G1: "
                + ((Point) pairing.getG1().newElement()).getLengthInBytesCompressed());
        System.out.println("Size Compressed G2: "
                + ((Point) pairing.getG2().newElement()).getLengthInBytesCompressed());
        ...
        int splitSize = pairing.getG1().getLengthInBytes() / 2 + 1;
        byte[] ag = DataManipulator.aggregateDataBlocks(splitSize, sig0_2_block);
        ...
        try {
            ...
            byte[][] b_read = DataManipulator.split_message(res, splitSize);
            assertTrue(bls0.verify(b_read, message0_2_block, id0_2_block, param_0));
            assertFalse(bls0.verify(b_read, message0_2_block + "A", id0_2_block, param_0));
        } catch (IOException e) {
    ...
    private static int discoverMaxMessageLength(AsymmetricCipherKeyPair keyPair0, BLSOptimized bls01) {
    ...
    private static void assertSignatureGeneration(BLSOptimized bls01,
