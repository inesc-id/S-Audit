...
public class BLSSigner {
    protected Element w;
    protected Element key = null;
    protected Element g;

    protected BLS01KeyParameters keyParameters;
    protected Digest digest;
    protected Pairing pairing;


    public BLSSigner(Digest digest, Element w) {
        this.w = w;
        this.digest = digest;
        this.g = null;
    ...
    public BLSSigner(Digest digest, Element w, Element g) {
        this.w = w;
        this.digest = digest;
        this.g = g;
