package homomorphic_authentication_library_Java.crypto;
...
public class PairingFactory {
    ...
    public static class CTL13MultilinearPairingCreator
            implements PairingCreator {
        ...
        public CTL13MultilinearPairingCreator() {
            try {
                ...
                getPairingMethod = pbcPairingFactoryClass.getMethod("getPairing",
                        SecureRandom.class, PairingParameters.class);
            } catch (Exception e) {
                throwable = e;
            }
    ...
    public class EllipticCurvesPairingCreator
        ...
        public EllipticCurvesPairingCreator() {
            ...
            try {
                Class pbcPairingFactoryClass = Class
                        .forName("it.unisa.dia.gas.plaf.jpbc.pbc.PBCPairingFactory");
    ...
    public static class DefaultSecureRandomCreator
            implements SecureRandomCreator {
    ...
    public PairingParameters loadParameters(String param) {
        InputStream stream = new ByteArrayInputStream(param.getBytes(StandardCharsets.UTF_8));

        PropertiesParameters curveParams = new PropertiesParameters();
        curveParams.load(stream);
