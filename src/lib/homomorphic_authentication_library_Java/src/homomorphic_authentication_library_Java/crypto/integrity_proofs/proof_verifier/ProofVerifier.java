package homomorphic_authentication_library_Java.crypto.integrity_proofs.proof_verifier;
...
public class ProofVerifier {
    ...
    public boolean verifyProof(Collection<Proof> pl,
        ...
        for (Proof p : pl) {
            ...
            Element w_p = pairing.getG2().newElementFromBytes(u_chal.getW().toBytes());
    ...
    private Element calculatePairedAlpha(Element alpha,
        ...
        Element alpha_hash = pairing.getG2().newElement();
        alpha_hash.setToOne();
        ...
        //w^alpha
        Element h_alpha = pairing.getG2().newElementFromBytes(w.toBytes());
        h_alpha.powZn(alpha);
